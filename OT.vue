...
import { useTrustStore } from './src/stores/trustStore'; // Corrected path from OT.vue to src/stores
import { useCriticalErrorStore } from './src/stores/criticalErrorStore'; // Corrected path from OT.vue to src/stores
