        ...
        <CCard class="bg-zinc-900 border-info text-white shadow-glow mb-4">
          <CCardBody class="text-center py-5">
            ...
            <h3 class="font-black italic text-white">
              {{ entityData.displayName || 'Sovereign_Node' }}
            </h3>
            <p class="tiny text-zinc-500 font-mono tracking-widest mb-4">{{ userId }}</p>

            <div
              class="biometric-stats d-flex justify-content-around border-top border-zinc-800 pt-4"
            >
              <div class="stat">
      ...
      <CCol lg="8">
        <CCard class="bg-zinc-900 border-zinc-800 text-white mb-4">
          <CCardHeader class="bg-zinc-800 border-0 font-black italic text-info"
            >ENTITY_LEDGER_STATUS</CCardHeader
          >
          <CCardBody class="p-4">
            <CRow class="g-4">
              <CCol sm="6">
                <div class="data-point p-3 bg-black border border-zinc-800 rounded">
                  ...
                  <span class="h4 font-black text-success"
                    >{{ entityData.iowb?.balance || 0 }} IO$</span
                  >
                </div>
              </CCol>
              <CCol sm="6">
                <div class="data-point p-3 bg-black border border-zinc-800 rounded">
                  <label class="tiny text-zinc-500 uppercase d-block mb-1"
                    >Thread_Affiliation</label
                  >
              ...
              <CCol sm="12">
                <div class="data-point p-3 bg-black border border-zinc-800 rounded">
                  <label class="tiny text-zinc-500 uppercase d-block mb-1"
                    >Informing_Source_Signature</label
                  >
