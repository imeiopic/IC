// IO-Government model for the VRE (Virtual Real Era/Earth/Economy/Ecosystem)
// Represents the digital government structure and logic for Iopic World

export interface IOGovernment {
  id: string;
  name: string;
  description: string;
...
export const ioGovernment: IOGovernment = {
  id: 'gov-0001',
  name: 'IO-Government',
  description: 'Maintains order, safety, and stability in the Iopic World VRE. Protects rights, promotes welfare, and provides essential public services.',
  ...
  welfarePrograms: [
    'Universal basic digital income',
    'Healthcare access',
    'Education grants',
  ],
  status: 'ACTIVE',
